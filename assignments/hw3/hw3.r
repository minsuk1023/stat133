...
# Your ggplot command
qplot(wr1500m$new_year,wr1500m$times_sec,data=wr1500m,geom="step") + geom_segment(aes(x=wr_1998,y=206,xend=2015,yend=206),lwd=0.2) + geom_vline(xintercept=wr_1944, col="green") + geom_vline(xintercept=wr_1998, col="green") + annotate("text", x=wr_1944, y=250, label=wr1500m$athlete[wr1500m$year==1944], adj=1, col="blue") +annotate("text", x=wr_1998, y=250, label=wr1500m$athlete[wr1500m$year==1998], adj=1, col="blue")
...
qplot(wr1500m$new_year,wr1500m$times_sec,data=wr1500m,geom="step")+ geom_segment(aes(x=wr_1998,y=206,xend=2015,yend=206),lwd=0.2) + geom_vline(xintercept=wr_1944, col="green") + geom_vline(xintercept=wr_1998, col="green") + annotate("text", x=wr_1944, y=250, label=wr1500m$athlete[wr1500m$year==1944], adj=1, col="blue") + annotate("text", x=wr_1998, y=250, label=wr1500m$athlete[wr1500m$year==1998], adj=1, col="blue") + labs(x="Year", y="Times (Seconds)", title="World Records in Running 1500m")
...
# Your ggplot command:
qplot(SO2012Ctry$GDP_per_person, SO2012Ctry$pop, size=sqrt(SO2012Ctry$Total), log="xy") + labs(x="Logged Population", y="Logged GDP_per_person", title="GDP_per_person to Population")+ annotate("text", x=SO2012Ctry$GDP_per_person[top5], y=SO2012Ctry$pop[top5], label=SO2012Ctry$Country[top5], adj=1, col="blue")
######################################
# PLOT 3.
...
qplot()+geom_polygon(data=world, aes(x=long, y=lat, group=group), fill="grey90", col="grey40")+ geom_point(aes(x = wonMedal$longitude, y = wonMedal$latitude, size = sqrt(wonMedal$Total)), colour = "gold")
## Not needed
...
ggplot(athletes, aes(athletes$Sport, fill=athletes$Sex)) + geom_bar(position="dodge")
...
# Your ggplot commands
ggplot(athletes, aes(athletes$Sport, fill=athletes$Sex)) + geom_bar(position="dodge") + theme(axis.text.x=element_text(angle=90)) + labs(x="Sport", title="Athletes", y="Number of Male/Female Athletes")
